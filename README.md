...
**Mozilla Firefox**
1. [Download and install the latest version](https://github.com/iamadamdev/bypass-paywalls-firefox/releases/download/v1.7.0/bypass_paywalls-1.7.0-an+fx.xpi)
